...
class InverseRelationship extends Relationship {
  function __construct (Model $from, Model $to, $type = 'inner') {
    parent::__construct ($from, $to, $type);
    $this->from_fields = array_keys ($from->GetPrimaryKey ());
    $this->to_fields = array_keys ($to->GetForeignKeyFor ($from));
